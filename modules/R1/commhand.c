...
void commhand()
{
	...
	printMessage("            ________________________________________________________________________________\n");
	printMessage("           /                                                                                \\\n");
	printMessage("           |    _______________________________________________________________________     |\n");
	printMessage("           |   |                                                                       |    |\n");
	printMessage("           |   |  C:\\> Welcome to our CS 450 Project!                                  |    |\n");
	printMessage("           |   |                                                                       |    |\n");
	printMessage("           |   |                                                                       |    |\n");
	printMessage("           |   |                                                                       |    |\n");
	printMessage("           |   |                                                                       |    |\n");
